...
const FIELD_ORDER = ["name", "email", "phone", "jewelryType", "description"];
...
export default function CustomPage() {
  ...
  const validateFields = () => {
    ...
    if (!formData.jewelryType) {
      errors.jewelryType = "Please choose a type of jewelry.";
    }

    if (!formData.description.trim()) {
      errors.description = "Please describe your vision.";
    }
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
              Your custom order request has been received. We will reach out
              within 24 hours to discuss your dream piece.
              {submittedRequestId && (
                <>
                  <br />
                  <br />
            ...
            >
              A 50% advance payment will be confirmed with you directly before
              crafting begins. The remaining balance can be paid via Cash on
              Delivery.
            </p>
            <button
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              50% advance payment required before crafting. Remaining 50% via
              Cash on Delivery.
            </p>
          </div>
        ...
        >
          ...
          <div className="desktop-info">
            ...
            >
              Every piece of jewelry tells a story. Whether you want a custom
              necklace for a special occasion, a personalized bracelet for a
              loved one, or a unique charm that captures a memory — I am here to
            ...
            >
              ...
              >
                For custom orders, we require a 50% advance payment before
                starting the crafting process. The remaining 50% can be paid via
                Cash on Delivery when you receive your finished piece.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <br />
                <span style={{ fontWeight: "600" }}>Timeline:</span> Custom
                pieces typically take 3-5 days.
                <br />
                <span style={{ fontWeight: "600" }}>Quality:</span> Premium
            ...
            <form onSubmit={handleSubmit} noValidate ref={formRef}>
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: "12px",
                    border: `1px solid ${fieldErrors.name ? "#e08a8a" : "#f0dbd9"}`,
                    fontFamily: "inherit",
                    fontSize: "1rem",
                    background: "#fef9f7",
                    transition: "0.3s",
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: "12px",
                    border: `1px solid ${fieldErrors.email ? "#e08a8a" : "#f0dbd9"}`,
                    fontFamily: "inherit",
                    fontSize: "1rem",
                    background: "#fef9f7",
                    transition: "0.3s",
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: "12px",
                    border: `1px solid ${fieldErrors.phone ? "#e08a8a" : "#f0dbd9"}`,
                    fontFamily: "inherit",
                    fontSize: "1rem",
                    background: "#fef9f7",
                    transition: "0.3s",
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <select
                  ...
                  onChange={handleChange}
                  ref={(el) => {
                    fieldRefs.current.jewelryType = el;
                  }}
                  style={{
                    width: "100%",
                    padding: "10px 14px",
                    borderRadius: "12px",
                    border: `1px solid ${fieldErrors.jewelryType ? "#e08a8a" : "#f0dbd9"}`,
                    fontFamily: "inherit",
                    fontSize: "1rem",
                    background: "#fef9f7",
                    color: "#3d2c2a",
              ...
              <div style={{ marginBottom: "14px" }}>
                ...
                <textarea
                  ...
                  style={{
                    ...
                    padding: "10px 14px",
                    borderRadius: "12px",
                    border: `1px solid ${fieldErrors.description ? "#e08a8a" : "#f0dbd9"}`,
                    fontFamily: "inherit",
                    fontSize: "1rem",
                    background: "#fef9f7",
                    resize: "vertical",
              ...
              >
                ...
                >
                  <strong>Note:</strong> For custom orders, a 50% advance
                  payment is required before we start crafting your piece. The
                  remaining 50% can be paid via Cash on Delivery upon delivery.
                </p>
              </div>
